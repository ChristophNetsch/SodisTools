...
#    api_secret=keyParser.get("Trello Access","API Secret").replace(" ", "")
    ...
    try:
        ...
        print('ERROR: Report aborted. Please provide correct Trello credentials in env.list-file.')
...
#    verification_token = keyParser.get("App Credentials","Verification Token").replace(" ", "")
    try:
        ...
        print('ERROR: Report aborted. Please provide correct Slack credentials in env.list-file.')
...
if __name__=='__main__':
    ...
    try:
        ...
        try:
            allreports = os.environ['ALL_REPORTS']
        except:
            allreports=False
